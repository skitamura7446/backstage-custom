...
import { MediaTypes, NamespacePluginOptions, StringElement, Element, ArrayElement, Meta, Attributes, ObjectElement, BooleanElement, MemberElement, ElementPredicate } from '@swagger-api/apidom-core';
...
declare const createToolbox: () => {
    predicates: {
        isStringElement: _swagger_api_apidom_core.ElementPredicate<minim.StringElement>;
        isCallbackElement: _swagger_api_apidom_core.ElementPredicate<Callback>;
        isComponentsElement: _swagger_api_apidom_core.ElementPredicate<Components>;
        isContactElement: _swagger_api_apidom_core.ElementPredicate<Contact>;
        isExampleElement: _swagger_api_apidom_core.ElementPredicate<Example>;
        isExternalDocumentationElement: _swagger_api_apidom_core.ElementPredicate<ExternalDocumentation>;
        isHeaderElement: _swagger_api_apidom_core.ElementPredicate<Header>;
        isInfoElement: _swagger_api_apidom_core.ElementPredicate<Info>;
        isLicenseElement: _swagger_api_apidom_core.ElementPredicate<License>;
        isLinkElement: _swagger_api_apidom_core.ElementPredicate<Link>;
        isOpenapiElement: _swagger_api_apidom_core.ElementPredicate<Openapi>;
        isOpenApi3_0Element: _swagger_api_apidom_core.ElementPredicate<OpenApi3_0>;
        isOperationElement: _swagger_api_apidom_core.ElementPredicate<Operation>;
        isParameterElement: _swagger_api_apidom_core.ElementPredicate<Parameter>;
        isPathItemElement: _swagger_api_apidom_core.ElementPredicate<PathItem>;
        isPathsElement: _swagger_api_apidom_core.ElementPredicate<Paths>;
        isReferenceElement: _swagger_api_apidom_core.ElementPredicate<Reference>;
        isRequestBodyElement: _swagger_api_apidom_core.ElementPredicate<RequestBody>;
        isResponseElement: _swagger_api_apidom_core.ElementPredicate<Response>;
        isResponsesElement: _swagger_api_apidom_core.ElementPredicate<Responses>;
        isSchemaElement: _swagger_api_apidom_core.ElementPredicate<Schema>;
        isBooleanJsonSchemaElement: _swagger_api_apidom_core.ElementPredicate<minim.BooleanElement>;
        isSecurityRequirementElement: _swagger_api_apidom_core.ElementPredicate<SecurityRequirement>;
        isServerElement: _swagger_api_apidom_core.ElementPredicate<Server>;
        isServerVariableElement: _swagger_api_apidom_core.ElementPredicate<ServerVariable>;
        isMediaTypeElement: _swagger_api_apidom_core.ElementPredicate<MediaType>;
        isServersElement: _swagger_api_apidom_core.ElementPredicate<Servers>;
        isReferenceLikeElement: (element: unknown) => element is ReferenceLikeElement;
        isServerLikeElement: _swagger_api_apidom_core.ElementPredicate<minim.ObjectElement>;
        isTagLikeElement: _swagger_api_apidom_core.ElementPredicate<minim.ObjectElement>;
        isOpenApiExtension: (element: minim.MemberElement) => boolean;
    };
        ...
        readonly document: {
            readonly objects: {
                ...
                readonly Schema: {
                    ...
                    readonly fixedFields: {
                        readonly title: stampit.default.Stamp<any>;
                        readonly multipleOf: stampit.default.Stamp<any>;
                        readonly maximum: stampit.default.Stamp<any>;
                        readonly exclusiveMaximum: stampit.default.Stamp<any>;
                        readonly minimum: stampit.default.Stamp<any>;
                        readonly exclusiveMinimum: stampit.default.Stamp<any>;
                        readonly maxLength: stampit.default.Stamp<any>;
                        readonly minLength: stampit.default.Stamp<any>;
                        readonly pattern: stampit.default.Stamp<any>;
                        readonly maxItems: stampit.default.Stamp<any>;
                        readonly minItems: stampit.default.Stamp<any>;
                        readonly uniqueItems: stampit.default.Stamp<any>;
                        readonly maxProperties: stampit.default.Stamp<any>;
                        readonly minProperties: stampit.default.Stamp<any>;
                        readonly required: stampit.default.Stamp<any>;
                        readonly enum: stampit.default.Stamp<any>;
                        readonly type: stampit.default.Stamp<any>;
                        readonly allOf: stampit.default.Stamp<any>;
                        readonly anyOf: stampit.default.Stamp<any>;
                        readonly oneOf: stampit.default.Stamp<any>;
                        readonly not: stampit.default.Stamp<any>;
                        readonly items: stampit.default.Stamp<any>;
                        readonly properties: stampit.default.Stamp<any>;
                        readonly additionalProperties: stampit.default.Stamp<any>;
                        readonly description: stampit.default.Stamp<any>;
                        readonly format: stampit.default.Stamp<any>;
                        readonly default: stampit.default.Stamp<any>;
                        readonly nullable: {
                            readonly $ref: "#/visitors/value";
                        };
