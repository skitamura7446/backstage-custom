...
class Proto2JsonSchema {
    ...
    compileField(field, parentItem) {
        let obj = {};
        if (primitive_types_1.PrimitiveTypes.PRIMITIVE_TYPES[field.type.toLowerCase()]) {
            obj = Object.assign(obj, primitive_types_1.PrimitiveTypes.PRIMITIVE_TYPES[field.type.toLowerCase()]);
